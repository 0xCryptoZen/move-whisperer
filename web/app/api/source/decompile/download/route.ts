...
export async function POST(request: NextRequest) {
  try {
    const body = await request.json() as { packageId?: string; decompiled?: Record<string, string>; decompileAt?: string };
...
This code was decompiled using MoveWhisperer built-in decompiler.

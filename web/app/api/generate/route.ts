...
export async function POST(request: NextRequest) {
  try {
    ...
    const { input, network, scene = 'sdk' } = body;
    ...
    const packageName = `${formatPackageName(actualModuleName || 'module')}-${scene}`;
...
*Generated by auto-sui-skills | Scene: SDK Integration*
`;
...
*Generated by auto-sui-skills | Scene: Protocol Learning*
`;
}
...
*Generated by auto-sui-skills | Scene: Security Audit*
...
*Generated by auto-sui-skills | Scene: Frontend Development*
`;
}
...
*Generated by auto-sui-skills | Scene: Trading Bot*
`;
}
...
*Generated by auto-sui-skills | Scene: Documentation*
`;
}
